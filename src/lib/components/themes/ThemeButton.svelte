...
<button class="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-sm text-black hover:bg-gray-100 dark:hover:bg-gray-100" on:click={toggle}>
	...
	<span>
		<span class:hidden={!dark}>Dark</span><span class:hidden={dark}>Light</span> mode 
	</span>
</button>